...
| `SUPABASE_SERVICE_ROLE_KEY` | strongly yes | queue, lock, jobs, admin create, refunds, topup credit |
| `TRUEWALLET_PHONE` | yes for topup | merchant TrueMoney mobile that receives angpao (e.g. 0812345678) |
